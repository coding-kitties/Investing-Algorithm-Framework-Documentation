        ...
        <Container maxWidth="lg">
            ...
            <Alert variant={"standard"} severity={"info"}>
                <Typography>REQUEST! Our goal is to solve the biggest issues for developers. It helps us enormously
                    if we can interview you by calling you or mailing you some questions that requires 15 minutes of your time to answer.
                    This helps us to learn how we can support you. If interested, send an email to <a className={classes.link}>codingkitties@gmail.com</a>
                </Typography>
            </Alert>
            <br/>
            <br/>
